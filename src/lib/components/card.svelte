...
<div class="relative border border-[#E6E6E6] w-full lg:w-[339px] h-[159px] lg:h-[281px] rounded-2xl p-6 overflow-hidden" style="background: linear-gradient(180deg, #FFFFFF 0%, #F9FAFB 100%);">
    ...
    <div class="relative z-10 flex flex-col justify-between h-full">
        ...
        <div class="flex items-center gap-3">
            ...
            <img src={icon} alt="" class="w-8 h-8 sm:w-8 sm:h-8"/>
        </div>
